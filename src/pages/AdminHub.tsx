...
const AdminHub: React.FC = () => {
    ...
    return (
        <>
            ...
            {/* Make sure the URL matches your exact file name in the public folder */}
            <div 
            ...
            {/* 1. Added 'relative z-10' to float above the background
                2. Removed 'bg-[#fffff]' so the background image can be seen 
            */}
            <div className="relative z-10 min-h-[85vh] bg-transparent overflow-hidden flex flex-col items-center justify-center p-4 py-20 md:py-0 font-sans">
